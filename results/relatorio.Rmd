...
## Verificando a qualidade de ajuste do modelo

```{r}
performance_hosmer(modelo_agrupado)
```

Como a hipótese nula não foi rejeitada, não há evidências nos dados que indiquem que o ajuste não foi bom.
